...
%plots of the original data and the best-fit model function

figure(1); plot(N, x, 'blue', 'linewidth', 10);

%axes labels
xlabel('N');
ylabel('x values');

figure(2); plot(N, f, 'red', 'linewidth', 10);

%axes labels
xlabel('N');
ylabel('Best-fit Model function');
