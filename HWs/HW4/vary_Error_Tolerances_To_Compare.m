...
% interpolation method converges quicker than the golden search method; 
% however, it does not always converge quicker. 
% I think it changes its convergence speed because with a higher accuracy
% threshold, there are less parabolas that have to be made for the
